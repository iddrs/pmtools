...
printnl('=======================================================================');
printnl('TRANSFERÊNCIAS DA EDUCAÇÃO');
printnl('Valor acumulado no ano da receita de transferências da educação.');
printnl('=======================================================================');
printnl('');
printnl('');
...
$sql = "SELECT
   ...
   FROM pad.bal_rec
  WHERE tipo_nivel_receita ~~ 'A'::text AND fonte_recurso >= 550 AND fonte_recurso <= 599 AND natureza_receita::text ~~ '17%'::text AND entidade::text ~~ 'pm'::text
  AND remessa = $1;";
